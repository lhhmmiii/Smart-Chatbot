...
# def extract_info(pdf_path, html_file_path):
...
# list_page_content = extract_info('Document\PDF\K2021-Danh sach tien quyet va hoc truoc-DHCQ.pdf', 'Document/HTML/output.html')
